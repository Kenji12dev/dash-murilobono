          ...
          <AreaChart data={data} margin={{ top: 5, right: 10, left: 0, bottom: 0 }}>
            <defs>
              <linearGradient id="revenueGradient" x1="0" y1="0" x2="0" y2="1">
                <stop offset="0%" stopColor="hsl(152, 72%, 45%)" stopOpacity={0.4} />
                <stop offset="100%" stopColor="hsl(95, 72%, 50%)" stopOpacity={0.02} />
              </linearGradient>
              <linearGradient id="lineGradient" x1="0" y1="0" x2="1" y2="0">
                <stop offset="0%" stopColor="hsl(152, 72%, 45%)" />
                <stop offset="100%" stopColor="hsl(95, 72%, 50%)" />
              </linearGradient>
            </defs>
            <CartesianGrid strokeDasharray="3 3" stroke="hsl(160, 14%, 17%)" vertical={false} />
            <XAxis dataKey="date" axisLine={false} tickLine={false} tick={{ fill: "hsl(155, 12%, 60%)", fontSize: 12 }} />
            <YAxis axisLine={false} tickLine={false} tick={{ fill: "hsl(155, 12%, 60%)", fontSize: 12 }} tickFormatter={formatCurrency} />
